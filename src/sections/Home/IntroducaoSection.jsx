...
export function IntroducaoSection() {
    ...
    return (
        <section className="m-10 flex flex-col text-(--cinzaClaro) justify-center items-center" id="introducao-section">
            <div className="relative justify-center flex">
                <div className="absolute opacity-30 inset-0 flex justify-between">
                ...
                <h1 className="text-(--textoTema) text-center text-5xl relative mt-20 flex flex-col">
                    Olá, eu sou <span className="text-(--textoDestaque)"> Pedro Henrique</span>
                </h1>
            </div>
            ...
            <hr className="w-4/5 my-6 border-(--textoTema) opacity-35"/>
