...
export function Apresentacao() {
    ...
    return (
        <section id="apresentacao" className="min-h-screen py-20 flex items-center justify-center relative bg-linear-to-br from-gray-50 to-gray-100 dark:from-black dark:to-gray-900">
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3 mb-12">
                        {
                            skillApresentacao.map((skill, index) => (
                                <span key={index} className="px-4 py-2 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:text-gray-300 dark:border-gray-700  text-gray-700 shadow-lg hover:shadow-cyan-500/30 hover:border-cyan-500/50 transition-all cursor-default">
                                    {skill}
                                </span>
                            ))
                        }
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <a href="#contato" className="px-8 py-4 rounded-xl border-2 border-cyan-500 text-cyan-600 dark:text-cyan-400 font-semibold hover:bg-cyan-500/10 transition-all">
                            Entrar em Contato
                        </a>
                    </div>
                </div>
            </div>
            <a href="#sobre" className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-gray-600 dark:text-gray-400 hover:text-cyan-500 transition-colors animate-bounce">
                <FaArrowDown size={20} />
            </a>
        </section>
    )
