...
export function Projetos() {
    ...
    return (
        <section id="projetos" className="py-24 bg-white dark:bg-gray-950 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
                    {projects.map((project, index) => (
                        <div
                        key={index}
                        className="group bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-800 hover:border-cyan-500/50 hover:shadow-cyan-500/20 transition-all"
                        >
                            <div className="relative h-64 overflow-hidden bg-gray-200 dark:bg-gray-800">
                                ...
                                <div className="absolute inset-0 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                    <div className="absolute inset-0 flex items-center justify-center gap-4">
                                        <a
                                        href={project.github}
                                        className="p-3 rounded-full bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-lg hover:bg-cyan-500 hover:text-white transition-colors"
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {project.skill.map((skill) => (
                                        <span
                                        key={skill}
                                        className="px-3 py-1 text-sm rounded-full bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border border-cyan-500/20"
                                        >
                                            {skill}
                                        </span>
                                    ))}
                ...
                <div className="text-center mt-12">
                    ...
                    className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border-2 border-cyan-500 text-cyan-600 dark:text-cyan-400 font-semibold hover:bg-cyan-500/10 transition-all"
                    >
                        Veja o GitHub completo
                        <FiExternalLink size={20} />
                    </a>
                </div>
            </div>
